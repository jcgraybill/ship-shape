...
func main() {
	...
	planets[2] = planet.New(500, 140, map[int]uint8{resource.Ice: 64, resource.Iron: 196}, rd)
	planets[3] = planet.New(550, 250, map[int]uint8{resource.Habitability: 50, resource.Iron: 60}, rd)
